			...
			public void run() {
				...
				if( skinNames != null ){
                    for (String skinName : skinNames) {
                        ...
                        try {
                            InputStream skinInfo = TGFileUtils.getResourceAsStream("skins/" + skinName + "/skin.properties");
                            if (skinInfo != null) {
                        ...
                        SkinInfo info = new SkinInfo(skinName);
							...
							SkinOption.this.combo.addSelectionListener(new SelectionAdapter() {
								public void widgetSelected(SelectionEvent e) {
									...
									if(selection >= 0 && selection < SkinOption.this.skins.size()){
										showSkinInfo(SkinOption.this.skins.get(selection));
									}
								}
							});
