        ...
        this.currentText.addKeyListener(new KeyAdapter() {
            public void keyReleased(KeyEvent e) {
                if (e.keyCode == KeyBindingConstants.ENTER) {
                    try {
                        int number = Integer.parseInt(PrintPreview.this.currentText.getText());
                        changePage(number - 1);
        ...
        this.pageComposite.addPaintListener(new PaintListener() {
            public void paintControl(PaintEvent e) {
                if (PrintPreview.this.currentPage >= 0) {
                    ...
                    painter.drawImage(PrintPreview.this.pages.get(PrintPreview.this.currentPage), MARGIN_LEFT, MARGIN_TOP - vScroll);
                }
            }
        });
